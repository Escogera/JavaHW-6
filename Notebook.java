...
public class Notebook {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Notebook notebook))
            return false;
        return Objects.equals(getStamp(), notebook.getStamp()) && Objects.equals(model, notebook.model)
                && Objects.equals(getRAM(), notebook.getRAM())
                && Objects.equals(getHardDiskCapacity(), notebook.getHardDiskCapacity())
                && Objects.equals(opirationSystem, notebook.opirationSystem) && Objects.equals(color, notebook.color);
    }
